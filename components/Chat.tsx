  ...
  const options = {
    ...
    initialMessages: [
      ...
      },
      {
        id: Date.now().toString(),
        role: "system" as const,
        content: `Your goal is to guide the student through an article, answer in short sentences, keep your answer concise, very short, break the article into small ideas and address only one idea at a time, respond with questions to test the student knowledge as you move on, try to break down ideas in an easy manner and respond with very short answers and follow up question. Article: ${article.title} ${article.body}`,
      },
    ],
  };
